...
func GenerateAuthToken(authContext map[string]interface{}) TokenRequest {
	...
	iterateAuthContext([]string{"IsRoot", "UserARN", "RoleARN", "ClientARN", "ClientName", "FirstName", "LastName", "Username", "Groups", "Permissions", "Device", "IsExternal", "Service"}, &authToken, authContext)
	return authToken
}
